    ...
    <div>
        <nav class="navbar navbar-dark navbar-expand-md sticky-top py-3" id="mainNav">
            <div class="container">
                ...
                <router-link to="/SugnUp" class="btn btn-primary shadow" role="button">Sign up</router-link>
            </div>
        </nav>
        <section class="py-5">
                    ...
                    <div class="col-md-6 col-xl-4">
                        <div class="card">
                            <div class="card-body text-center d-flex flex-column align-items-center">
                                ...
                                <div>
                                    <div class="mb-3">
                                        <input class="form-control" type="email" name="email" placeholder="Email" v-model="FormData.Email">
                                    </div>
                                    <div class="mb-3">
                                        <input class="form-control" type="password" name="password" placeholder="Password" v-model="FormData.Password">
                                    </div>
                                    <div class="mb-3">
                                        <button class="btn btn-primary shadow d-block w-100" @click="SubmitForm()">Sign up</button>
                                    </div>
                                    <p class="text-muted">已經註冊過會員了?&nbsp;&nbsp;<a href="login.html">Log in</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        methods: {
            SubmitForm() {
                ...
                if(this.FormData.Email || this.FormData.Password) {
                    LoginApiHelper.SignUp(this.FormData).then(($response) => {
                        if($response.success) {
                            loading(false);
